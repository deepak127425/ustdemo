...
public class CalculatorMortgage {
    ...
    public static void main (String args[]) {
        ...
        int principal = (int)Calcultor_Console.readNumber("Principal: ",1000,1000000);
        float annual = (float)Calcultor_Console.readNumber("Annaul rate: ",1,30);
        byte period = (byte)Calcultor_Console.readNumber("years: ",1,30);
